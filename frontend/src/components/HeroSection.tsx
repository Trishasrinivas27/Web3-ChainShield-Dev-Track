  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="floating-shape w-64 h-64 bg-primary/15 bottom-20 left-1/4 blur-2xl" style={{ animationDelay: "2s" }} />
        <div className="floating-shape-delayed w-72 h-72 bg-accent/10 bottom-40 right-1/4 blur-3xl" style={{ animationDelay: "4s" }} />
